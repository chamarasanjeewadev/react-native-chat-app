...
const SvgGroupIcon = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      fill="#FDE047"
      d="M16.718 5.99a2.648 2.648 0 1 0 0-5.297 2.648 2.648 0 0 0 0 5.297"
    />
    <Path
      fill="#1E293B"
    ...
    <G filter="url(#groupIcon_svg__a)">
      <Path
        fill="#FDE047"
        d="M23.868 19.226a2.648 2.648 0 1 0 0-5.296 2.648 2.648 0 0 0 0 5.296"
      />
    </G>
    <G filter="url(#groupIcon_svg__b)">
      <Path
        fill="#FDE047"
        d="M9.57 19.226a2.648 2.648 0 1 0 0-5.296 2.648 2.648 0 0 0 0 5.296"
      />
    </G>
