    ...
    <ScrollView>
      <View style={styles.uiTemplatemobileprofile}>
        ...
        <View style={[styles.sectionTitle, styles.sectionParentFlexBox]}>
          <View
            style={[
              styles.sectionTitleBadgesParent,
              styles.sectionParentFlexBox,
            ]}
          >
        ...
        <View style={styles.totalXpCard}>
          ...
          <View
            style={[
              styles.subsectionSubheadingParent,
              styles.subsectionShadowBox,
            ]}
          >
            <View style={styles.subsectionFlexBox}>
            ...
            <View style={[styles.userName1, styles.userFlexBox]}>
              <View
                style={[
                  styles.wrapperRankBadgesComponents,
                  styles.miniIconLayout,
                ]}
              >
                <Image
              ...
              <View
                style={[styles.subsectionSubheading1, styles.subsectionFlexBox]}
              >
                <Text style={[styles.heading3, styles.headingTypo]}>
                  250/500
                </Text>
        ...
        <View style={[styles.dailyStreak, styles.userCardShadowBox]}>
          ...
          <View
            style={[
              styles.subsectionSubheadingGroup,
              styles.subsectionShadowBox,
            ]}
          >
            <View style={styles.subsectionFlexBox}>
            ...
            <View
              style={[
                styles.streakDaysAndIconParent,
                styles.sectionParentFlexBox,
              ]}
            >
        ...
        <View style={[styles.newWordsLearnd, styles.userCardShadowBox]}>
          ...
          <View style={[styles.newWordsBoxParent, styles.newParentFlexBox]}>
            <View style={[styles.newWordsBox, styles.newShadowBox]}>
              ...
              <View
                style={[styles.newWordsLearnednewWordsLa, styles.newLayout]}
              >
                <Text style={[styles.newWordsLabel, styles.newPosition]}>
                  Today
                </Text>
              </View>
            </View>
          ...
          <View style={[styles.newWordsBox3, styles.newShadowBox]}>
            ...
            <View style={styles.newWordsNumber6}>
              <Text style={[styles.newWordsNumber7, styles.newLayout1]}>
                76
              </Text>
            </View>
          ...
          <View style={styles.buttonsbuttonShadowBox}>
            ...
            <View style={[styles.textPadding, styles.streakFlexBox]}>
              <Text style={[styles.text3, styles.newLayout2]}>
                Check Out New Words
              </Text>
            </View>
            <Image
        ...
        <View style={[styles.chatsCompleted, styles.userCardShadowBox]}>
          ...
          <View style={[styles.newWordsBoxParent, styles.newParentFlexBox]}>
            <View style={[styles.chatsCompleted1, styles.newShadowBox]}>
              ...
              <View
                style={[
                  styles.newWordsLearnednewWordsLa4,
                  styles.newParentFlexBox,
                ]}
              >
                <Text style={[styles.newWordsLabel4, styles.newTypo]}>
                  Guided
                </Text>
              </View>
            </View>
            <View style={[styles.chatsCompleted2, styles.newShadowBox]}>
              ...
              >
                <Text style={[styles.newWordsLabel5, styles.newTypo]}>
                  Supportive
                </Text>
              </View>
            </View>
            <View style={[styles.chatsCompleted3, styles.newShadowBox]}>
              ...
              >
                <Text style={[styles.newWordsLabel6, styles.newTypo]}>
                  Independent
                </Text>
              </View>
            </View>
